...
Point(5) = {0, b, 0, 0.3*resolution};
Point(6) = {a, 0, 0, 0.3*resolution};
Point(7) = {a*Cos(theta),b*Sin(theta),0,0.3*resolution};
...
Curve Loop(24) = { 19, -29,-30, 22}; //inclusion
//
...
Physical Curve("boundary_curve", 18) = {29,30};
